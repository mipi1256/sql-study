...
-- LTRIM, RTRIM, TRIM
-- TRIM() -> 양쪽 공백 제거
-- LTRIM(param1, param2) -> param2의 값을 param1에서 찾아서 제거 (왼쪽부터 탐색)
-- RTRIM(param1, param2) -> param2의 값을 param1에서 찾아서 제거 (오른쪽부터 탐색)
SELECT
...
-- REPLACE(str, old, new) -> 문자열 대체
SELECT
    REPLACE('My dream is a president', 'president', 'proggrammer')
FROM dual;

SELECT
    REPLACE(REPLACE('My dream is a president', 'president', 'proggrammer'), ' ', '')
FROM dual;
