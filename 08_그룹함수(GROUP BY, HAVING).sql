...
SELECT COUNT(*) FROM employees; -- 총 행 데이터의 수. To know that amount of rows in the data
SELECT COUNT(first_name) FROM employees;
SELECT COUNT(commission_pct) FROM employees; -- COUNT doesn't count the NULL value. NULL이 아닌 행의 수
...
-- 일반 컬럼과 그냥 출력할 수는 없습니다. 그룹이 필요합니다.
SELECT
    department_id,
    AVG(salary)
FROM employees;
