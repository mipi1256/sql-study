...
-- 외부 조인
/*
상호 테이블간에 일치되는 값으로 연결되는 내부 조인과는 다른게
...
WHERE e.department_id = d.department_id(+) -- You add the plus sign to get the information that has the value of NULL
AND d.location_id = loc.location_id(+); -- This add the information in both tables that have the value of NULL.
